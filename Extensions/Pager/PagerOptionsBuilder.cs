...
namespace Extensions.Pager
{
    ...
    public class PagerOptionsBuilder
    {
        ...
        /// <returns></returns>
        public PagerOptionsBuilder MaxNumOfPages(int maxNrOfPages)
        {
    ...
    public class PagerOptionsBuilder<TModel> : PagerOptionsBuilder
    {
        ...
        /// <param name="maxNrOfPages"></param>
        /// <returns></returns>
        public new PagerOptionsBuilder<TModel> MaxNumOfPages(int maxNrOfPages)
        {
            base.MaxNumOfPages(maxNrOfPages);
            return this;
        }
